...
<div>
    <div>
        <h2 class="featurette-heading">Privacy Policy for TaskSwap</h2>
    </div>
</div>

<div class="row featurette">
    <div>
        <h2 class="featurette-heading fw-normal lh-1" >1. Information We Collect <span>
                <p class="lead" style="font-family: 'Poppins', sans-serif; font-size: 20px;">
                    <br>1.1 Personal Information: We may collect personal information such as names, email addresses, and other relevant details when users sign up for TaskSwap. <br><br>
                    1.2 Usage Data: We may collect information about how users interact with TaskSwap, including log files, device information, and browsing activity.
...
<div class="row featurette">
    <div>
        <h2 class="featurette-heading fw-normal lh-1" >2. How We Use Your Information<span>
                <p class="lead" style="font-family: 'Poppins', sans-serif; font-size: 20px;">
                    <br>2.1 Providing Services: We use collected information to offer and improve TaskSwap's services, including task management, communication, and user support.<br><br>
                    2.2 Communication: We may use your contact information to send important updates, notifications, or promotional materials related to TaskSwap.
                    </p>
    </div>
</div>
...
<div class="row featurette">
    <div>
        <h2 class="featurette-heading fw-normal lh-1" >3. Information Sharing<span>
                <p class="lead" style="font-family: 'Poppins', sans-serif; font-size: 20px;">
                    <br>3.1 Legal Compliance: We may disclose information in response to legal requests, such as subpoenas or court orders, or to comply with applicable laws.
                </p>
    </div>
</div>
...
<div>
    <div>
        <h2 class="featurette-heading fw-normal lh-1">4. Security<span>
                <p class="lead" style="font-family: 'Poppins', sans-serif; font-size: 17px; ">
                    <br>4.1 Data Security: TaskSwap employs industry-standard security measures to protect user information from unauthorized access, disclosure, or alteration.<br><br>
                    4.2 Account Security: Users are responsible for maintaining the confidentiality of their account credentials and are encouraged to use strong, unique passwords.
                </p>
    </div>
</div>
